...
if (!$resultadoConsulta = mysql_query($consultarColaboradorExiste)) {
    ...
    if ($arrayUsuario['total'] == 0) {
        ...
        if (!mysql_query("update usuario set idTipoUsuario=2  where idUsuario = " . $id_colaborador . " ;")) {
            die("Erro de update: " . mysql_error());
        } else {
            echo "<html><head><meta charset=\"utf-8\"/></head><body> ";
            echo "Esta mensagem será enviada por email";
            echo "<br/><br/>";
            echo "Olá " . $arrayUsuario['nomeUsuario'] . ", você foi movido para colaborador do sistema \"Palavras indiginas\".";
            echo "<br/><br/>";
            echo "Agradecemos por contribuir com este sistema. Seus dados para acesso continua os mesmos.";
